        ...
        <div className="footer-content">
          <div className="footer-section footer-brand">
            ...
            <div className="footer-social">
              <a href="https://www.instagram.com/sankalpam.official?igsh=bzRwYmVqdnNvZXY0" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <a href="https://youtube.com/@sankalpam_official?si=e-TM9BJhfBiCK11C" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
              <a href="tel:" target="_self" aria-label="Call us" style={{ display: "flex", alignItems: "center", justifyContent: "center", color: "#000", textDecoration: "none", }} >
              ...
              <a href="mailto:sankalpamofficial@gmail.com" aria-label="Email">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-info">
              <li>PT : 620, FLAT NO. 501, JANANI PARADISE APARTMENTS, MATHRUSRI NAGAR, MIYAPUR, HYDERABAD, TELANGANA- 500049.</li>
              <li>Email: sankalpamofficial@gmail.com</li>
              <li>Phone: +91 9121718321</li>
            </ul>
          </div>
        </div>
